...
echo "Step 1: throttle: 0.30, steer: 0.0"
timeout 20s ros2 topic pub -r 20 /carla/hero/vehicle_control_cmd_manual carla_msgs/msg/CarlaEgoVehicleControl \
  "{throttle: 0.32, steer: 0.0, brake: 0.0, hand_brake: false, reverse: false, manual_gear_shift: false, gear: 1}"
...
timeout 28s ros2 topic pub -r 20 /carla/hero/vehicle_control_cmd_manual carla_msgs/msg/CarlaEgoVehicleControl \
  "{throttle: 0.26, steer: 0.10, brake: 0.0, hand_brake: false, reverse: false, manual_gear_shift: false, gear: 1}"

echo "Step 4: throttle: 0.35, steer: 0.0"
timeout 9s ros2 topic pub -r 20 /carla/hero/vehicle_control_cmd_manual carla_msgs/msg/CarlaEgoVehicleControl \
  "{throttle: 0.30, steer: 0.0, brake: 0.0, hand_brake: false, reverse: false, manual_gear_shift: false, gear: 1}"
...
timeout 13s ros2 topic pub -r 20 /carla/hero/vehicle_control_cmd_manual carla_msgs/msg/CarlaEgoVehicleControl \
  "{throttle: 0.26, steer: 0.12, brake: 0.0, hand_brake: false, reverse: false, manual_gear_shift: false, gear: 1}"

echo "Step 6: throttle: 0.35, steer: 0.0"
timeout 5s ros2 topic pub -r 20 /carla/hero/vehicle_control_cmd_manual carla_msgs/msg/CarlaEgoVehicleControl \
  "{throttle: 0.30, steer: 0.0, brake: 0.0, hand_brake: false, reverse: false, manual_gear_shift: false, gear: 1}"
