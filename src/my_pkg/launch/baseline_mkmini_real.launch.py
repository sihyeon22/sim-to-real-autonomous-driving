# File: baseline_mkmini_real.launch.py
# Author: sihyeon
# Date: 2026.04.16 WED
# Description:
#     MK-Mini 실차 기준 Nav2 베이스라인
...
ARGUMENTS = [
    ...
    DeclareLaunchArgument(
        'nav2_params',
        default_value=PathJoinSubstitution([
            FindPackageShare('my_pkg'), 'config', 'nav2_params_mkmini_real.yaml'
        ]),
...
def generate_launch_description():
    ...
    # TF: base_link -> Ouster OS1 표준 프레임 (MK-Mini 마운팅 위치)
    lidar_tf = Node(
        package='tf2_ros',
